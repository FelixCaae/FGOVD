...
def main():
    ...
    coco_path = '/gpfsdata/home/caizhi/dataset/coco/'
    ...
    if args.large:
        model = OwlViTForObjectDetection.from_pretrained("/gpfsdata/home/caizhi/FG-OVD_yangshuai/weights/owlvit-large-patch14")
        processor = OwlViTProcessor.from_pretrained("/gpfsdata/home/caizhi/FG-OVD_yangshuai/weights/owlvit-large-patch14")
        print("Large model loaded")
    else:
        model = OwlViTForObjectDetection.from_pretrained("/gpfsdata/home/caizhi/FG-OVD_yangshuai/weights/owlvit-base-patch16")
        processor = OwlViTProcessor.from_pretrained("/gpfsdata/home/caizhi/FG-OVD_yangshuai/weights/owlvit-base-patch16")
